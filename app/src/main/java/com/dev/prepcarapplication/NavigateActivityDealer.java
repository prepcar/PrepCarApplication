...
import com.dev.prepcarapplication.fragment.FragmentNavigateScreenDealer;

import org.json.JSONObject;

public class NavigateActivityDealer extends BaseFragmentActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_container);
		replaceFragement(FragmentNavigateScreenDealer.newInstanse(null),FragmentNavigateScreenDealer.TAG);
	}
	...
	private void commonCallBack(Object object, int requestCode, Object fragment2) {
		...
		switch (requestCode) {
		case Constants.getBuyer:
			if (jObject.optInt("dataFlow") == Constants.FLOW) {
				((FragmentNavigateScreenDealer)fragment2).setresponce(jObject);
			} else {
				// showDialog(message);
			}
			break;
	...
	public void showDialog(String msg){
		final AlertDialog.Builder builder = new AlertDialog.Builder(NavigateActivityDealer.this);
